 ...
 * When your component renders, `useLaunchesInfoQuery` returns an object from Apollo Client that contains loading, errr, and data properties
...
export function useLaunchesInfoQuery(baseOptions?: Apollo.QueryHookOptions<LaunchesInfoQuery, LaunchesInfoQueryVariables>) {
        ...
        return Apollo.useQuery<LaunchesInfoQuery, LaunchesInfoQueryVariables>(LaunchesInfoDocument, options);
      }
export function useLaunchesInfoLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<LaunchesInfoQuery, LaunchesInfoQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}
          return Apollo.useLazyQuery<LaunchesInfoQuery, LaunchesInfoQueryVariables>(LaunchesInfoDocument, options);
        }
